...
#    Updated: 2021/08/01 20:10:14 by sesnowbi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= test_main.c \
			...
			srcs/other_utils/read_doc.c srcs/other_utils/envs_in_heredoc.c srcs/other_utils/envs_in_heredoc_utils.c \
...
FLAGS	= -g -lreadline -L/Users/sesnowbi/.brew/Cellar/readline/8.1/lib -I /Users/sesnowbi/.brew/Cellar/readline/8.1/include -Llibft -lft -Wall -Werror -Wextra# -fsanitize=address
